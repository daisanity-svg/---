...
const typeModules = {
  sensitive: {
    ...
    stuck: ['你最近卡住的，不是事情本身。\n\n是你一直在回想細節。'], pattern: ['你會先檢討自己。\n\n哪怕對方其實沒有說你錯。'], blind: ['不是每一個語氣變化，都跟你有關。'], strength: ['你其實很會看細節。\n\n只是別再每次都拿來懲罰自己。'], next: ['下一次開始亂想時，先停一下。\n\n問自己：這是事實，還是我最害怕的劇情？']
  },
  pressure: {
    core: ['你很常一邊說可以。\n\n一邊其實已經快不行了。', '很多事情沒有人叫你扛。\n\n但你就是放不下。'],
    stuck: ['你卡住的地方，是一直覺得自己還能再撐一下。'], pattern: ['別人沒想到的，你會補。\n\n別人沒收好的，你會收。'], blind: ['你不需要累到壞掉，才算盡力。'], strength: ['你很可靠。\n\n但可靠不代表要一直被消耗。'], next: ['接下來，少接一件不是非你不可的事。\n\n先把自己留下來。']
  },
  fog: {
    core: ['你不是沒有方向。\n\n是原本的方向，已經不太能說服你了。', '你不是停住。\n\n你是在轉彎。'],
    stuck: ['你卡住的，是想改變，卻不知道從哪裡開始。'], pattern: ['你會想很多可能。\n\n想到最後，反而什麼都沒有開始。'], blind: ['有些方向，是走了才清楚。'], strength: ['你其實正在更新。\n\n不是壞掉。'], next: ['先做一件很小的事。\n\n小到不會害怕。\n\n但足夠讓你開始往前。']
  },
  suppressed: {
    core: ['你很常說沒事。\n\n但其實根本不是沒事。', '很多話到了嘴邊。\n\n最後變成一句算了。'],
    stuck: ['你卡住的，是那些沒有說出口的失望。'], pattern: ['你怕造成麻煩。\n\n所以最後都麻煩自己。'], blind: ['沉默不一定是成熟。\n\n有時候只是委屈。'], strength: ['你很能撐。\n\n但能撐，不代表應該一直撐。'], next: ['找一件小事說出來。\n\n不是為了吵架。\n\n是讓自己被聽見。']
  },
  caretaker: {
    core: ['你很常先顧別人的情緒。\n\n最後才想到自己。', '你嘴巴說沒關係。\n\n其實心裡已經有點失望。'],
    stuck: ['你累的不是付出。\n\n是付出了，卻沒有人真的看見。'], pattern: ['你會先想對方會不會難過。\n\n再決定自己要不要說真話。'], blind: ['被需要，不等於被愛。'], strength: ['你的溫柔是真的。\n\n但不要讓它變成消耗。'], next: ['答應之前，先停三秒。\n\n問自己：我是願意，還是不敢拒絕？']
  },
  attachment: {
    core: ['你會點開對話框。\n\n看一下。\n\n又關掉。', '你不是要很多。\n\n你只是想被堅定選擇。'],
    stuck: ['你卡住的，是對方沒有明說。\n\n你也沒有真的放下。'], pattern: ['你會假裝沒事。\n\n但其實一直在等對方主動。'], blind: ['不要用一個人的回覆速度，判斷你的價值。'], strength: ['你很真誠。\n\n只是別把真誠交給一直讓你不安的人。'], next: ['問自己一句：\n\n我在這段關係裡，真的安心嗎？']
  },
  control: {
    core: ['你不是愛控制。\n\n你只是很怕突然失控。'], stuck: ['你卡住的，是每件事都想做到不出錯。'], pattern: ['你會把事情排好。\n\n也會把自己逼很緊。'], blind: ['不完美，不一定會毀掉結果。'], strength: ['你很能把混亂整理好。\n\n這是能力，不該變成壓力。'], next: ['選一件小事，讓它不用完美。\n\n世界不會因此崩掉。']
  },
  defense: {
    core: ['你看起來很冷靜。\n\n其實只是很怕受傷。'], stuck: ['你卡住的，是明明在意，卻一直演得很淡。'], pattern: ['你會先觀察。\n\n再決定要不要打開自己。'], blind: ['保護自己沒有錯。\n\n但不要把自己關太久。'], strength: ['你很清醒。\n\n也不容易被漂亮話騙走。'], next: ['對一個相對安全的人，多說一點真話。\n\n一點點就好。']
  },
  lonely: {
    core: ['你不是不需要人。\n\n你只是太習慣自己消化。'], stuck: ['你卡住的，是很多事都只能自己吞下去。'], pattern: ['你會保持距離。\n\n不是高傲，是不想再失望。'], blind: ['不是所有靠近，都是打擾。'], strength: ['你很清醒。\n\n也很有自己的判斷。'], next: ['讓一個人多看見你一點。\n\n不用很多。\n\n一點點就好。']
  },
  stability: {
    core: ['你不是害怕改變。\n\n你只是需要慢一點。'], stuck: ['你卡住的，是一直在不確定裡找安全感。'], pattern: ['你會先想後果。\n\n再決定要不要開始。'], blind: ['改變也可以很小。\n\n也可以很慢。'], strength: ['你很能長期經營。\n\n只要找到節奏，就不容易放棄。'], next: ['先做一個小改變。\n\n小到不害怕。\n\n但足夠讓你知道：我可以往前。']
  }
};
...
$('[data-download]')?.addEventListener('click', () => downloadStoryImage());
...
function downloadStoryImage() {
  ...
  const gradient = ctx.createRadialGradient(980, 180, 20, 980, 180, 760);
  gradient.addColorStop(0, 'rgba(200,152,103,0.18)');
  gradient.addColorStop(1, 'rgba(60,83,67,0)');
  ctx.fillStyle = gradient;
  ctx.fillRect(0, 0, 1080, 1920);

  ctx.strokeStyle = 'rgba(243,230,222,0.12)';
  ctx.lineWidth = 2;
  roundedRect(ctx, 70, 70, 940, 1780, 44);
  ctx.stroke();
